...
export type GMMAInterval = "1d" | "1wk" | "1mo";
export type GMMARange = "3mo" | "6mo" | "1y" | "2y";

const INTERVALS: { label: string; value: GMMAInterval }[] = [
  { label: "日线", value: "1d" },
  { label: "周线", value: "1wk" },
  { label: "月线", value: "1mo" },
];

const RANGES: { label: string; value: GMMARange }[] = [
  { label: "3mo", value: "3mo" },
  { label: "6mo", value: "6mo" },
  { label: "1y",  value: "1y" },
  { label: "2y",  value: "2y" },
...
interface ControlBarProps {
  ...
  displayRange: GMMARange;
  loading: boolean;
  onAnalyze: (symbol: string, interval: GMMAInterval) => void;
  onRangeChange: (range: GMMARange) => void;
}
...
export default function ControlBar({
  ...
  const [currentInterval, setCurrentInterval] = useState<GMMAInterval>(interval);
