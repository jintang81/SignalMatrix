...
import type { InvertedDuckChartData } from "@/types";

interface Props {
  chart: InvertedDuckChartData;
}

// ─── Colors (bear variant — DIFF line is red) ─────────────────────
const C = {
  bg:      "#131c2e",
  grid:    "#1e2d42",
  zero:    "#2e3a50",
  bull:    "#26a69a",
  bear:    "#ef5350",
  diff:    "#ef5350",   // red — DIFF diverges down faster than DEA
  dea:     "#c9a84c",   // gold
...
export default function InvertedDuckChart({ chart }: Props) {
  ...
  const draw = useCallback(() => {
    ...
    // DIFF line (red — faster, diverges down)
